...
public class BM115PrimitiveMachineButtonPacket {
    ...
    public void handle(Supplier<NetworkEvent.Context> supplier){
        ...
        context.enqueueWork(() -> {
            ...
            if (player != null && player.containerMenu instanceof BM115PrimitivePaPMenu menu){
                // ここでMenuクラスで実装した処理を呼び出すらしい
                // テスト用にplayerにシステムメッセージを送りつける
                player.sendSystemMessage(Component.literal("hogehogepiyopiyo"));
            }
        });
